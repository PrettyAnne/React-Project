...
import MagnerMint from '../../images/content1-slide1-2.gif';
import OliveBrench from '../../images/content1-slide1-3.gif';
        ...
        <div class="product-slide">
          <div class="prod1">
            <a href="./magic-crystal.html">
              <img src={MagicCrystals} alt="매직 크리스탈스 300g/600g" /><br />
          ...
          <div class="prod2">
            <a href="javascript:void(0)">
              <img src={MagnerMint} alt="마스크 오브 매그너민트 125g/315g" /><br />
          ...
          <div class="prod3">
            <a href="javascript:void(0)">
              <img src={OliveBrench} alt="더 올리브 브랜치 100g/250g/500g" /><br />
    ...
    <section>
      ...
      <div class="info-wrap">
        <div class="info-wrap-left">
          <a href="javascript:void(0)"><img src={ConsTantin} alt="마크 콘스탄틴과 함께하는 퍼퓸 이야기" /></a>
        </div> {/* info-wrap-left */}
        ...
        <div class="info-wrap-right">
          ...
          <div class="info-wrap-right-bottom">
            ...
            <div class="info-wrap-right-bottom-right">
              <a href="javascript:void(0)">
                <img src={Covid} alt="코로나19 예방을 위한 매장 운영 안내" />
              </a>    
